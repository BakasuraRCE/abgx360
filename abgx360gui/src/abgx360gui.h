...
public:
    abgx360gui(wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT("abgx360gui"), const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize,
               long style = abgx360gui_STYLE);
